...
namespace LCM.Services.Implements
{
    public class DataService : IDataService
    {
        ...
        public async Task<int> InsertS18(DataTable dt, string updateUser)
        {
            var res = 0;
            ...
            foreach (var dr in dt.AsEnumerable())
            {
                ...
                listData.Add(new XxPor0001_Resell()
                {
                    ...
                    OrderNo = dr[s18Header.Order_Number].ToString(),
        ...
        public async Task<int> InsertB18(DataTable dt, string updateUser)
        {
            var res = 0;
        ...
        public async Task ExportPkBs18(DataTable dt)
        {
            ...
            foreach (var dr in dt.AsEnumerable())
            {
                ...
                listData.Add(new LCM.Services.Models.VENDOR_REPORT()
                {
                    ...
                    S18_PE_No = dr[vendorReportHeader.S18_PE_No].ToString(),
                    S18_SO_No = dr[vendorReportHeader.S18_SO_No].ToString(),
                    S18_SO_Line = dr[vendorReportHeader.S18_SO_Line].ToString(),
                    S18_PN = dr[vendorReportHeader.S18_PN].ToString(),
                    S18_Qty = s18_Qty,
                    S18_Unit_Price = s18oUnitPrice,
                    B18_SO_No = dr[vendorReportHeader.B18_SO_No].ToString(),
                    B18_SO_Line = !string.IsNullOrEmpty(dr[vendorReportHeader.B18_PO_No].ToString()) && !string.IsNullOrEmpty(dr[vendorReportHeader.B18_PO_Line_No].ToString()) ? currentSO_Line : null,//dr[vendorReportHeader.S18_SO_Line].ToString(),
                    B18_PO_No = dr[vendorReportHeader.B18_PO_No].ToString(),
                    B18_PO_Line_No = b18_PoLineNo,
                    B18_PN = dr[vendorReportHeader.B18_PN].ToString(),
                    B18_Qty = b18_Qty,
                    B18_PO_Shipment_Date = DateOnly.FromDateTime(b18_PoShipmentDate),
                    B18_PO_Unit_Price = b18_PoUnitPrice,
                    B18_Project = dr[vendorReportHeader.B18_Project].ToString(),
                    B18_Note = dr[vendorReportHeader.B18_Note].ToString()
                });
            }
            ...
            {
                SN = serialNo,
                S18_Promised_Date = c.S18_Promised_Date,
                S18_PE_No = c.S18_PE_No,
                S18_SO_No = c.S18_SO_No,
                S18_SO_Line = c.S18_SO_Line,
                S18_PN = c.S18_PN,
                S18_Qty = c.S18_Qty,
                S18_Unit_Price = c.S18_Unit_Price
            ...
            {
                SN = serialNo,
                B18_SO_No = c.B18_SO_No,
                B18_SO_Line = c.B18_SO_Line,
                B18_PO_No = c.B18_PO_No,
                B18_PO_Line_No = c.B18_PO_Line_No,
                B18_PN = c.B18_PN,
                B18_Qty = c.B18_Qty,
                B18_PO_Shipment_Date = c.B18_PO_Shipment_Date,
                B18_PO_Unit_Price = c.B18_PO_Unit_Price,
                B18_Note = c.B18_Note
            });
            ...
            foreach (var s18_V_Item in s18VendorReportData)
            {
                ...
                data.DB_S18_PENo = StringPK(s18_V_Item.S18_PE_No.Trim(), dbS18?.PENo?.Trim(), ref errorCount);
                data.DB_S18_OrderNo = StringPK(s18_V_Item.S18_SO_No.Trim(), dbS18?.OrderNo?.Trim(), ref errorCount);
                data.DB_S18_SOLine = StringPK(s18_V_Item.S18_SO_Line.Trim(), dbS18?.SOLine?.Trim(), ref errorCount);
                data.DB_S18_PartNo = StringPK(s18_V_Item.S18_PN.Trim(), dbS18?.PartNo?.Trim(), ref errorCount);
                data.DB_S18_Quantity = StringPK(s18_V_Item.S18_Qty.ToString().Trim(), dbS18?.Quantity.ToString()?.Trim(), ref errorCount);
                data.DB_S18_NetPrice = StringPK(s18_V_Item.S18_Unit_Price.ToString().Trim(), dbS18?.NetPrice.ToString()?.Trim(), ref errorCount);
                ...
                if (b18_V_Items.Count > 0)
                {
                    ...
                    foreach (var b18_V_Item in b18_V_Items)
                    {
                        ...
                        //DB大18
                        data.DB_B18_PONo = StringPK(b18_V_Item.B18_PO_No.Trim(), dbB18?.PONo.Trim(), ref errorCount);
                        data.DB_B18_POLineNo = StringPK(b18_V_Item.B18_PO_Line_No.ToString()?.Trim(), dbB18?.POLineNo.ToString()?.Trim(), ref errorCount);
                        data.DB_B18_PartNo = StringPK(b18_V_Item.B18_PN.Trim(), dbB18?.PartNo?.Trim()!, ref errorCount);
                        data.DB_B18_Quantity = StringPK(b18_V_Item.B18_Qty.ToString().Trim(), dbB18?.Quantity.ToString()?.Trim(), ref errorCount);
                        if (dbB18 != null)
                        {
            ...
            //輸出Excel報表
            wb.SaveAs(Path.Combine(System.IO.Directory.GetCurrentDirectory(), @"Content\pk.xlsx"));
            #endregion
        }
        ...
        private void AddMergeString(ref List<PK_RESULT_REPORT> data)
        {
            ...
            var dataWithNewNote =
                ...
                b => new { SONo = b.SONo, SOLineNo = b.SOLineNo },
